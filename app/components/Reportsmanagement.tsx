...
export default function ReportsManagement() {
    ...
    return (
        <div className="space-y-6 relative">
            ...
            {/* Filter Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 p-4 bg-[#0f2233]/40 backdrop-blur-md border border-white/5 rounded-2xl animate-slide-up stagger-1.5">
                {/* Start Date Filter */}
